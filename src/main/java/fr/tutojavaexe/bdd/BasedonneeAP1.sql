...
CREATE TABLE `frais` (
  ...
  PRIMARY KEY (`FR_ID`),
  UNIQUE KEY `FR_ID_UNIQUE` (`FR_ID`),
  KEY `FR_Taxes_idx` (`FR_Taxes`),
  KEY `FK_Montant_idx` (`FR_Montant`),
  KEY `ID_Fiche_idx` (`id_fiche`),
  CONSTRAINT `id_fiche` FOREIGN KEY (`id_fiche`) REFERENCES `fiche` (`ID`)
...
-- Dump completed on 2021-01-29 10:41:51
